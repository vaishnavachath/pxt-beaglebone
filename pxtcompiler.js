...
(function (ts) {
    ...
    (function (pxtc) {
        ...
        function decompile(opts, fileName, includeGreyBlockMessages, bannedCategories) {
            ...
            var bresp = pxtc.decompiler.decompileToBlocks(blocksInfo, file, { snippetMode: false, alwaysEmitOnStart: opts.alwaysDecompileOnStart, includeGreyBlockMessages: includeGreyBlockMessages }, pxtc.decompiler.buildRenameMap(program, file));
            return bresp;
        }
